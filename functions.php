...
if (defined('WP_DEBUG') && WP_DEBUG && defined('WP_DEBUG_LOG') && WP_DEBUG_LOG) {
    set_error_handler(function (int $errno, string $errstr, string $errfile, int $errline): bool {
        error_log(sprintf("[DEBUG TRACE] %s in %s on line %d\n%s", $errstr, $errfile, $errline, (new Exception())->getTraceAsString()));
        return false;
...
require_once get_template_directory() . '/anketa/anketa-pdf.php';
require_once get_template_directory() . '/anketa/onedrive.php';
require_once get_template_directory() . '/anketa/admin-page.php';
