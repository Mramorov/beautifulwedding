...
function anketa_handle_form_submit(WP_REST_Request $request) {
    ...
    if (!empty($client_email)) {
        ...
        $sections = [
            'Жених' => ['groom_full_name','groom_birth_surname','groom_passport','groom_birthdate','groom_birthplace','groom_citizenship','groom_marital_status','groom_address','groom_education'],
            'Родители жениха — отец' => ['groom_father_name','groom_father_birth_surname','groom_father_birthdate','groom_father_birthplace'],
            'Родители жениха — мать' => ['groom_mother_name','groom_mother_birth_surname','groom_mother_birthdate','groom_mother_birthplace'],
            'Невеста' => ['bride_full_name','bride_birth_surname','bride_passport','bride_birthdate','bride_birthplace','bride_citizenship','bride_marital_status','bride_address','bride_education'],
            'Родители невесты — отец' => ['bride_father_name','bride_father_birth_surname','bride_father_birthdate','bride_father_birthplace'],
            'Родители невесты — мать' => ['bride_mother_name','bride_mother_birth_surname','bride_mother_birthdate','bride_mother_birthplace'],
            'Договорённости' => ['surname_choice','wedding_location','translation_language','certificate_address'],
        ];
        $missing_by_section = [];
        foreach ($sections as $section => $keys) {
            $missing = [];
            foreach ($keys as $key) {
                if (empty($save[$key])) $missing[] = $labels[$key];
            }
