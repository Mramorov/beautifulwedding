        ...
        <form id="marriageApplicationForm" class="marriage-form">
            <div class="anketa-grid">
                ...
                <div class="anketa-block anketa-block--docs">
                    ...
                    <h3>Жених</h3>
                    <?php _anketa_render_doc_field('passport_z', 'Паспорт жениха', $_anketa_existing_files); ?>
                    <?php _anketa_render_doc_field('rozdenie_z', 'Свидетельство о рождении жениха', $_anketa_existing_files); ?>
                    <div class="doc-rozvod-z-wrap" style="<?= isset($_anketa_existing_files['rozvod_z']) ? '' : 'display:none;' ?>">
                        <?php _anketa_render_doc_field('rozvod_z', 'Свидетельство о разводе жениха', $_anketa_existing_files, 'Только для разведённых и вдовцов'); ?>
                    </div>
                    <h3>Невеста</h3>
                    <?php _anketa_render_doc_field('passport_n', 'Паспорт невесты', $_anketa_existing_files); ?>
                    <?php _anketa_render_doc_field('rozdenie_n', 'Свидетельство о рождении невесты', $_anketa_existing_files); ?>
                    <div class="doc-rozvod-n-wrap" style="<?= isset($_anketa_existing_files['rozvod_n']) ? '' : 'display:none;' ?>">
                        <?php _anketa_render_doc_field('rozvod_n', 'Свидетельство о разводе невесты', $_anketa_existing_files, 'Только для разведённых и вдов'); ?>
                    </div>
                </div>
